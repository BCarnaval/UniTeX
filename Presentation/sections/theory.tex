...
\begin{frame}
    ...
    \end{defblock}
    \footnotetext{\textcolor{spruce_dark}{Maxime Charlebois}. "Théorie de champ moyen dynamique pour les
    système inhomogènes". \textcolor{spruce_medium}{Thèse de doct. Université Laval 2015}.}
\end{frame}
